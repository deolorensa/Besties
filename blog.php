...
//<li class="nav-item">Halo, '.$_SESSION["name"].'</li>
  ...
  <div class="span8">
    <div class="row">
      <div class="span8">
        <h4><strong><a href="blog2.php">Cara Menjadikan Kucing Penurut</a></strong></h4>
      </div>
    </div>
    <div class="row">
      <div class="span2">
        <a href="#" class="thumbnail">
            <img src="assets/img/kucing2.png" alt="" width="600px" height="300px">
        </a>
      </div>
      <div class="span6">      
        <p>
        Sebenarnya, tidak sulit untuk melatih kucing menjadi penurut. Tapi dengan syarat PetLovers tau tipsnya dan sabar dalam menerapkan tips tersebut. Apa saja yang harus PetLovers lakukan jika ingin membuat kucing jadi penurut?
        </p>
        <p><a class="btn" href="blog2.php">Read more</a></p>
      </div>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="span8">
    <div class="row">
      <div class="span8">
        <h4><strong><a href="blog1.php">Anjing menjadi akrab dengan majikan</a></strong></h4>
      </div>
    </div>
    <div class="row">
      <div class="span2">
        <a href="#" class="thumbnail">
            <img src="assets/img/gambar1.jpg" alt="" width="600px" height="300px">
        </a>
      </div>
      <div class="span6">      
        <p>
        Jika anjing peliharaan tampak ketakutan atau enggan berada di dekat Anda,
        ...
        <p><a class="btn" href="blog1.php">Read more</a></p>
      </div>
    </div>
  </div>
</div>
